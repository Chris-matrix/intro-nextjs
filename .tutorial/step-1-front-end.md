...
**BookList Component (`app/components/BookList.js`)**
...
**AddBookForm Component (`app/components/AddBookForm.js`)**
...
**UpdateBookForm Component (`app/components/UpdateBookForm.js`)**
...
**Create and Add the sign-in and sign out: (`signin/page.js`):** 
...
**Integrate Components into Page (`app/page.js`)**
